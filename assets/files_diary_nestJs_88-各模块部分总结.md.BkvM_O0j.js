import{_ as a,c as n,o as p,af as e}from"./chunks/framework.Cj92BNWl.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"files/diary/nestJs/88-各模块部分总结.md","filePath":"files/diary/nestJs/88-各模块部分总结.md","lastUpdated":1738744669000}'),i={name:"files/diary/nestJs/88-各模块部分总结.md"};function l(t,s,r,o,c,d){return p(),n("div",null,s[0]||(s[0]=[e(`<h2 id="_88" tabindex="-1">88 <a class="header-anchor" href="#_88" aria-label="Permalink to &quot;88&quot;">​</a></h2><p>大概图解</p><div class="language-ssh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ssh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>src/</span></span>
